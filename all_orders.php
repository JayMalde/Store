            ...
            try
            {
                ...
                if($result>0)
                {
                    ...
                    ?>
                        ...
                        <td><a href="update_order.php?id=<?php echo $or['order_id']; ?>">Edit</a></td>
                        <td><a onclick="return confirm('Do you want to delete this record from orders table.');" href="delete_order.php?id=<?php echo $or['order_id']; ?>">Delete</a></td>
                    </tr> 
                    <?php
                    }
                }
