            ...
            try
            {
                ...
                if($result>0)
                {
                    ...
                    ?>
                        ...
                        <td><a href="update_user.php?id=<?php echo $or['id']; ?>">Edit</a></td>
                        <td><a href="delete_user.php?id=<?php echo $or['id']; ?>" onclick="return confirm('Do You Want To Delete The User')">Delete</a></td>
                        </tr> 
                            <?php
                      }
                }
