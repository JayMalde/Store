            ...
            try
            {
                ...
                if($result>0)
                {
                    while($or = mysqli_fetch_assoc($result))
                    {
                      ...
                      <td><a href="update_category.php?category_id=<?php echo $or['category_id']; ?>">Edit</a></td>
                      <td><a href="delete_category.php?category_id=<?php echo $or['category_id']; ?>" onclick="return confirm('Do You Want To Delete The Category')">Delete</a></td>
                      </tr> 
                      <?php
                    }
                }
