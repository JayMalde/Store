            ...
            try
            {
                ...
                if($result>0)
                {
                	...
                	?>
                        ...
                        <td><a href="update_product.php?product_id=<?php echo $or['product_id']; ?>">Edit</a></td>
                        <td><a href="delete_product.php?product_id=<?php echo $or['product_id']; ?>" onclick="return confirm('Do you want to delete this Product')">Delete</a></td>
        </tr>	
                    <?php
                    }
        	    }
